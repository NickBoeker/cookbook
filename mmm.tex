...
\subsubsection{Glaze}
\begin{itemize}
\item 1/3 cup freshly squeezed lemon juice
...
\begin{enumerate}
\item{Preheat oven to 350\degree F
\item Beat together butter, sugar, salt until fluffy
\item Add eggs one at a time, beating well after each addition
\item Add baking powder and then alternating between flour and milk in parts. Stir in lemon
\item Spoon into pan and level
\item Bake 40-60 mins, test that a toothpick comes out clean
\item Stir together glaze, either microwave or heat on stove to dissolve sugar
\item Remove cake from pan and let sit, brush glaze over and let cool
